...
# Validate required environment variables and warn early if any are missing.
# Caldera / FTP vars are optional (only needed for specific scenarios).
_REQUIRED_VARS = {
...
if _missing:
    print(
        ...
        f"{', '.join(_missing)}. "
        "Copy .env_template to .env and fill in the values before running agents.",
        file=sys.stderr,
    )
